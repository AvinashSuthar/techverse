...
Create a [`public` folder](/docs/app/api-reference/file-conventions/public-folder) at the root of your project to store static assets such ass, fonts, etc. Files inside `public` can then be referenced by your code starting from the base URL (`/`).
...
export default function Page() {
  return  src="/profile.png" alt="Profile" width={100} height={100} />
}
```
