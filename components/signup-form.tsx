...
export default async function SignupForm() {
  ...
  return (
    <div className="shadow-input mx-auto my-10 w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black">
      ...
      <Link
        href={"/login"}
        className="my-2 cursor-pointer hover:text-sky-300 duration-300 transition-all"
      >
